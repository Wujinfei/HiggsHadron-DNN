...
def main():
    ...
    if do_model_fit == 1:
        ...
        history3 = model3.fit(X_train,Y_train,validation_data=(X_test, Y_test, testweights), epochs=200, batch_size=50, verbose=1, shuffle=True, sample_weight=trainweights)
